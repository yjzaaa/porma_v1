...
// 子模块
import { FeishuConnection } from './feishu/connection/FeishuConnection'
import { FeishuBindingRepository } from './feishu/bindings/FeishuBindingRepository'
import { FeishuSender } from './feishu/FeishuSender'
import { FeishuMessageDedup, MESSAGE_DEBOUNCE_MS } from './feishu/messages/FeishuMessageDedup'
import { FeishuAttachmentDownload } from './feishu/messages/FeishuAttachmentDownload'
import { FeishuMessageRouter } from './feishu/messages/FeishuMessageRouter'
import { FeishuCommandHandler } from './feishu/messages/FeishuCommandHandler'
import { FeishuCardStreamer } from './feishu/streaming/FeishuCardStreamer'
import { FeishuSessionMirror } from './feishu/streaming/FeishuSessionMirror'
import { FeishuGroupService } from './feishu/group/FeishuGroupService'
import { FeishuHistoryFetcher } from './feishu/history/FeishuHistoryFetcher'
import { FeishuMcpProvider } from './feishu/mcp/FeishuMcpProvider'
import { resolveContextPrefix, resolveContextSubtitle } from './feishu/context'
...
import { buildAgentUserMessage, fetchQuotedMessage } from './feishu/prompt-builder'
